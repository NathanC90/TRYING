...
public class MemberBean implements Serializable{
	...
	private java.sql.Timestamp registerDate;    //會員註冊日期
	private double weight;               //體重
	
	public MemberBean(){	
	}
	
	public MemberBean(String memberId, String name, String password, String address, String phone, Date birthday, Timestamp registerDate, double weight){
		super();
